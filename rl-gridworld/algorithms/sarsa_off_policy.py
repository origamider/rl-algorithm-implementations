...
class SarsaOffPolicyAgent:
    def __init__(self):
        ...
        self.b = defaultdict(lambda:random_probs)
    ...
    def update(self,state,action,reward,done):
        ...
        self.pi[state] = self.greedy_probs(state,epsilon=0.0,action_size=self.action_size) # ターゲット方策はgreedy
        self.b[state] = self.greedy_probs(state,self.epsilon,self.action_size) # 挙動方策はε-greedyに。